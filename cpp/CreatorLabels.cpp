    ...
    Node* CreatorLabels_create()
{
    ...
    // New node
    auto label_1 = Label::createWithSystemFont("System Font Label: 32", "arial", 32);
    label_1->setAnchorPoint(Vec2(0.5, 0.5));
    label_1->setScaleY(1);
    label_1->setScaleX(1);
    label_1->setColor(Color3B(0, 255, 0));
    label_1->setName("Label");
    label_1->setVerticalAlignment(TextVAlignment::CENTER);
    label_1->setLocalZOrder(0);
    label_1->setGlobalZOrder(0);
    label_1->setOpacity(255);
    label_1->setOpacityModifyRGB(false);
    label_1->setCascadeOpacityEnabled(true);
    label_1->setHorizontalAlignment(TextHAlignment::CENTER);
    label_1->setSkewX(0);
    label_1->setTag(-1);
    label_1->setContentSize(Size(320.17, 40));
    label_1->setSkewY(0);
    label_1->setRotationSkewY(0);
    label_1->setPosition(Vec2(186, 117));
    label_1->setRotationSkewX(0);
    scene_0->addChild(label_1);
    // New node
    auto label_2 = Label::createWithBMFont("creator_assets/arial16.fnt", "BMFont: Arial 16");
    label_2->setAnchorPoint(Vec2(1, 1));
    label_2->setScaleY(1);
    label_2->setScaleX(1);
    label_2->setLineHeight(19);
    label_2->setColor(Color3B(71, 0, 255));
    label_2->setName("arial16");
    label_2->setVerticalAlignment(TextVAlignment::TOP);
    label_2->setLocalZOrder(0);
    label_2->setBMFontSize(40);
    ...
    label_2->setSkewX(0);
    label_2->setTag(-1);
    label_2->setContentSize(Size(280, 47.5));
    label_2->setSkewY(0);
    label_2->setRotationSkewY(0);
    label_2->setPosition(Vec2(300, 71));
    label_2->setRotationSkewX(0);
    scene_0->addChild(label_2);
    // New node
    auto label_3 = Label::createWithTTF("TTF Font: A Damn Mess: 64", "creator_assets/A Damn Mess.ttf", 64);
    label_3->setAnchorPoint(Vec2(0, 0));
    label_3->setScaleY(1);
    label_3->setScaleX(1);
    label_3->setLineHeight(64);
    label_3->setColor(Color3B(255, 0, 0));
    label_3->setName("A Damn Mess");
    label_3->setVerticalAlignment(TextVAlignment::TOP);
    label_3->setLocalZOrder(0);
    label_3->setGlobalZOrder(0);
    label_3->setOpacity(255);
    label_3->setOpacityModifyRGB(false);
    label_3->setCascadeOpacityEnabled(true);
    label_3->setHorizontalAlignment(TextHAlignment::LEFT);
    label_3->setSkewX(0);
    label_3->setTag(-1);
    label_3->setContentSize(Size(748.47, 64));
    label_3->setSkewY(0);
    label_3->setRotationSkewY(0);
    label_3->setPosition(Vec2(21, 181));
    label_3->setRotationSkewX(0);
    scene_0->addChild(label_3);
    // New node
    auto label_4 = Label::createWithTTF("This is a\nmultiline\nTTF label: Left", "creator_assets/American Typewriter.ttf", 32);
    label_4->setAnchorPoint(Vec2(0.5, 0.5));
    label_4->setScaleY(1);
    label_4->setScaleX(1);
    label_4->setLineHeight(48);
    label_4->setColor(Color3B(255, 133, 0));
    label_4->setName("A Damn Mess");
    ...
    label_4->setHorizontalAlignment(TextHAlignment::LEFT);
    label_4->setSkewX(0);
    label_4->setTag(-1);
    label_4->setContentSize(Size(222.81, 144));
    label_4->setSkewY(0);
    label_4->setRotationSkewY(0);
    label_4->setPosition(Vec2(472, 84));
    label_4->setRotationSkewX(0);
    scene_0->addChild(label_4);
    // New node
    auto label_5 = Label::createWithTTF("This is a\nmultiline\nTTF label:  Right", "creator_assets/American Typewriter.ttf", 32);
    label_5->setAnchorPoint(Vec2(0.5, 0.5));
    label_5->setScaleY(1);
    label_5->setScaleX(1);
    label_5->setLineHeight(64);
    label_5->setColor(Color3B(255, 224, 0));
    label_5->setName("A Damn Mess");
    label_5->setVerticalAlignment(TextVAlignment::CENTER);
    label_5->setLocalZOrder(0);
    label_5->setGlobalZOrder(0);
    label_5->setOpacity(255);
    label_5->setOpacityModifyRGB(false);
    label_5->setCascadeOpacityEnabled(true);
    label_5->setHorizontalAlignment(TextHAlignment::RIGHT);
    label_5->setSkewX(0);
    label_5->setTag(-1);
    label_5->setContentSize(Size(259.06, 192));
    label_5->setSkewY(0);
    label_5->setRotationSkewY(0);
    label_5->setPosition(Vec2(730, 102));
    label_5->setRotationSkewX(0);
    scene_0->addChild(label_5);
    return scene_0;
}
////// AUTOGENERATED:END//////
